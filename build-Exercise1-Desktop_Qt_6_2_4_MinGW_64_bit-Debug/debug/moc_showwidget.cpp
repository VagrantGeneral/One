...
#include <memory>
#include "../../Exercise1/showwidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ShowWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ShowWidget_t qt_meta_stringdata_ShowWidget = {
    {
QT_MOC_LITERAL(0, 10) // "ShowWidget"
...
const QMetaObject ShowWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ShowWidget.offsetsAndSize,
    qt_meta_data_ShowWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ShowWidget_t
, QtPrivate::TypeAndForceComplete<ShowWidget, std::true_type>
